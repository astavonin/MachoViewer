...
{
	if (self = [super init]) {
		NSString *tmpPath = [NSString stringWithCString:data->name encoding:NSUTF8StringEncoding];
		NSArray *pathComp = [tmpPath componentsSeparatedByCharactersInSet:[NSCharacterSet characterSetWithCharactersInString:@"/"]];
